  ...
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:py-8">
    <nav class="mb-4 text-sm text-slate-400" aria-label="Trilha de navegação">
      <ol class="flex flex-wrap items-center gap-1.5">
        ...
        <li aria-hidden="true">/</li>
        <li v-if="product" class="min-w-0 truncate text-slate-500">
          <RouterLink
        ...
        <li v-else class="text-slate-500">Produto</li>
        <li aria-hidden="true">/</li>
        <li class="text-slate-500" aria-current="page">Editar</li>
      </ol>
    </nav>

    <header class="mb-6 space-y-1 sm:mb-8">
      <h1 class="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Editar Produto</h1>
